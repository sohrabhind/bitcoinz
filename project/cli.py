...
def main(args=None):
    ...
    help_string = """
    This BitcoinZ Network CLI supports the following commands:
        ...
        try:
            ...
            if "add_address" in input_:
                ...
                if len(transaction_metadata)==2:
                    sender, receiver, amount = BitcoinZNetwork.MINTED, transaction_metadata[0], transaction_metadata[1]
                ...
                click.echo(
                '\n{amount} sent from {sender} to {receiver} via BitcoinZ Mixer.\n'
